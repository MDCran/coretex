...
import { Card as CardSurface } from "../../_components/financial-ui";
import { Button } from "@/components/base/buttons/button";
import { requireUser } from "@/lib/auth";
import { db } from "@/lib/db";
import { fileUrl } from "@/lib/files";
import { aiConfigured } from "@/lib/ai/claude";
import { computeCreditCardBalance } from "@/lib/financial/balance";
import { setCreditCardReplacedBy } from "@/lib/actions/financial-cards";
import { formatCurrency, formatDate, formatPercent } from "@/lib/financial/format";
import { formatDateOnly } from "@/lib/dates";
import { EmptyRow, SectionHeader, Stat } from "../../_components/financial-ui";
                    ...
                    <Detail label="Institution">
                        {card.institutionRef ? (
                            <Link
                                ...
                                className="inline-flex items-center gap-1.5 rounded-full bg-secondary py-1 pr-2.5 pl-1 text-xs font-medium text-secondary hover:bg-secondary_hover hover:text-primary"
                            >
