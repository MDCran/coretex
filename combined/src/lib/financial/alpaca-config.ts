...
import { openOptionalSecret } from "@/lib/secret-box";
...
export function openAlpacaConnectionKeys(conn: AlpacaConnectionKeys): AlpacaConnectionKeys {
    return {
        ...
        paperApiKey: openOptionalSecret(conn.paperApiKey, { provider: "alpaca", userId: conn.userId, field: "paperApiKey" }),
        paperApiSecret: openOptionalSecret(conn.paperApiSecret, { provider: "alpaca", userId: conn.userId, field: "paperApiSecret" }),
        liveApiKey: openOptionalSecret(conn.liveApiKey, { provider: "alpaca", userId: conn.userId, field: "liveApiKey" }),
        liveApiSecret: openOptionalSecret(conn.liveApiSecret, { provider: "alpaca", userId: conn.userId, field: "liveApiSecret" }),
    };
}
