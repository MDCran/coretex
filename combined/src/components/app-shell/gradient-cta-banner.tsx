        ...
        >
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex shrink-0 flex-wrap items-center gap-2.5">
                    <Link
                        href={primary.href}
                        className="group inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-gray-900 shadow-sm outline-focus-ring transition duration-100 ease-linear hover:bg-white/90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                    >
                        {primary.label}
                    ...
                    {secondary && (
                        <Link
                            href={secondary.href}
                            className="inline-flex items-center gap-2 rounded-lg bg-white/10 px-4 py-2.5 text-sm font-semibold text-white ring-1 ring-white/30 ring-inset outline-focus-ring transition duration-100 ease-linear hover:bg-white/20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                        >
                            {secondary.label}
                        </Link>
                    )}
