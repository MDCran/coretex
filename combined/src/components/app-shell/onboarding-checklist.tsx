                    ...
                    {steps.map((step) => (
                        <li key={step.id}>
                            {step.done ? (
                                ...
                                <Link
                                    href={step.href}
                                    className="group flex items-center gap-2.5 rounded-xl px-3 py-2.5 ring-1 ring-secondary ring-inset transition duration-100 ease-linear hover:bg-secondary_hover"
                                >
