                        ...
                        <AriaPopover
                            ...
                            className={({ isEntering, isExiting }) =>
                                cx(
                                    ...
                                    isEntering &&
                                        "duration-300 ease-out animate-in fade-in placement-right:slide-in-from-left-2 placement-top:slide-in-from-bottom-2 placement-bottom:slide-in-from-top-2 motion-reduce:animate-none motion-reduce:duration-0",
                                    isExiting &&
                                        "duration-150 ease-in animate-out fade-out placement-right:slide-out-to-left-2 placement-top:slide-out-to-bottom-2 placement-bottom:slide-out-to-top-2 motion-reduce:animate-none motion-reduce:duration-0",
                                )
                            }
                        >
                            <NavAccountMenu />
