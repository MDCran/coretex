                ...
                {(state) => {
                    ...
                    return (
                        <>
                            ...
                            {selectedItem ? (
                                // Trigger shows the option label only. Supporting text belongs in the
                                // open list (Select.Item) — putting both inline made compact Type/Category
                                // dropdowns read as a run-on sentence instead of "Fact" / "Preference".
                                <section className={cx("flex min-w-0 flex-1 truncate", sizes[size].textContainer)}>
