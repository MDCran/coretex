                    ...
                    <AriaPopover
                        ...
                        className={(state) =>
                            cx(
                                ...
                                state.isEntering &&
                                    "duration-150 ease-out animate-in fade-in placement-top:slide-in-from-bottom-0.5 placement-bottom:slide-in-from-top-0.5 motion-reduce:animate-none motion-reduce:duration-0",
                                state.isExiting &&
                                    "duration-100 ease-in animate-out fade-out placement-top:slide-out-to-bottom-0.5 placement-bottom:slide-out-to-top-0.5 motion-reduce:animate-none motion-reduce:duration-0",
                                popoverClassName,
                            )
                        }
                    >
