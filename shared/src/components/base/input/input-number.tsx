    ...
    return (
        ...
        >
            {orientation === "horizontal" && (
                <Button size={size} aria-label="Decrease value" iconLeading={Minus} slot="decrement" color="tertiary" className="static h-full rounded-r-none" />
            )}
            ...
            {orientation === "horizontal" && (
                <Button size={size} aria-label="Increase value" iconLeading={Plus} slot="increment" color="tertiary" className="static h-full rounded-l-none" />
            )}
