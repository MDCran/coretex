...
const styles = sortCx({
    root: "group relative flex min-h-11 w-full cursor-pointer touch-manipulation items-center rounded-md bg-primary outline-focus-ring transition duration-100 ease-linear select-none hover:bg-primary_hover focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-offset-2 lg:min-h-0 lg:max-h-9",
