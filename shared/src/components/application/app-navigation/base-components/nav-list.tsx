...
export const NavList = ({ activeUrl, items, className }: NavListProps) => {
    ...
    // Derive the active item from the current URL on every render so client-side
    // navigation always moves the highlight (state would freeze it at first mount).
                ...
                return (
                    <li key={item.label} className="py-px">
                        <NavItemBase
                            ...
                            open={open && activeItem?.href === item.href}
                        >
                            {item.label}
                        </NavItemBase>
                    </li>
