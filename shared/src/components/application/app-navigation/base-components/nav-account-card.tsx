                ...
                <AriaPopover
                    ...
                    className={({ isEntering, isExiting }) =>
                        cx(
                            ...
                            isEntering &&
                                "duration-150 ease-out animate-in fade-in placement-right:slide-in-from-left-0.5 placement-top:slide-in-from-bottom-0.5 placement-bottom:slide-in-from-top-0.5 motion-reduce:animate-none motion-reduce:duration-0",
                            isExiting &&
                                "duration-100 ease-in animate-out fade-out placement-right:slide-out-to-left-0.5 placement-top:slide-out-to-bottom-0.5 placement-bottom:slide-out-to-top-0.5 motion-reduce:animate-none motion-reduce:duration-0",
                        )
                    }
                >
