...
export const MusicView = (props: ViewProps) => {
    return (
        <div className="flex h-full flex-col gap-6 overflow-y-auto overflow-x-hidden p-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-xl font-semibold text-[var(--c-text-primary)]">Music Dashboard</h1>
                    <p className="text-sm text-[var(--c-text-tertiary)]">Manage your music.</p>
                </div>
            </div>
        </div>
    );
