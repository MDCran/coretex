...
import { RELATIONSHIP_LABELS, RELATIONSHIP_COLORS, labelOf } from "./enums";
import { initialsOf, fmtRelative, connectionHealth, type ConnectionHealth } from "./format";
...
function ContactCard({ c }: { c: DirectoryContact }) {
    ...
    return (
        <Link href={`/social/contacts/${c.id}`} className="group">
