...
import { saveBattery } from "./mock-actions";
import { createDraft } from "./mock-actions";
...
function QuickDraftModal({
    ...
    return (
        <FormModal isOpen={isOpen} onOpenChange={onOpenChange} title="New reach out">
            <form
                action={async (fd) => {
            ...
            >
                ...
                <div className="flex justify-end gap-2 pt-2">
                    ...
                    <Button type="submit">Create reach out</Button>
                </div>
            </form>
        </FormModal>
    );
