            ...
            <div className="flex flex-col gap-2">
                ...
                {events.length === 0 ? (
                    ...
                    <ul className="flex flex-col gap-1.5">
                        {events.map((e) => (
                            <li key={e.id}>
                                <Link href={e.href} className="flex items-center gap-2 rounded-lg bg-secondary px-2.5 py-2 text-sm font-medium text-primary transition hover:bg-secondary_hover">
                    ...
                    <ul className="flex flex-col divide-y divide-secondary">
                        {events.map((e) => (
                            <li key={e.id} className="flex items-center justify-between gap-3 py-3 first:pt-0 last:pb-0">
                                <Link href={e.href} className="flex min-w-0 items-center gap-2 text-sm font-medium text-primary hover:text-brand-secondary">
                                    <Gift01 className="size-4 shrink-0 text-fg-quaternary" aria-hidden="true" />
                                    <span className="truncate">{e.title}</span>
                                </Link>
