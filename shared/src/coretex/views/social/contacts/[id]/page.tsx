...
import { Card, CardHeader, CardBody, EmptyHint, DetailRow } from "../../ui";
import { Sparkline } from "../../sparkline";
import { Social, SocialsManager } from "../../socials-manager";
import { ScoreSliders } from "../../score-sliders";
import { RecordDialog, InlineDelete } from "../../record-dialog";
import { ReachOutActions } from "../../reach-out-actions";
import { Memory, MemoriesManager } from "../../memories-manager";
import { LocalTime } from "../../local-time";
import { LabelCombobox } from "../../label-combobox";
import { connectionHealth, activitySparkline, fmtDate, toDateInput, fmtRelative, toDateTimeInput, initialsOf } from "../../format";
import { EMAIL_LABELS, PHONE_LABELS, listOptions, DATE_TYPES, ADDRESS_TYPES, toOptions, NOTE_TYPE_LABELS, labelOf, INTERACTION_TYPE_LABELS, CHANNEL_LABELS, SENTIMENT_LABELS, SENTIMENT_COLORS, GIFT_DIRECTIONS, OCCASIONS, REMINDER_TYPE_LABELS, RELATIONSHIP_COLORS, RELATIONSHIP_LABELS, CONTACT_METHOD_LABELS, COMMUNICATION_FREQUENCY_LABELS } from "../../enums";
import { ContactTabs } from "../../contact-tabs";
import { AddToCalendarButton } from "../../add-to-calendar-button";
import { DateInput, Button } from "react-aria-components";
import { Activity } from "react";
import { subDays } from "date-fns";
import { TextInput, Edit01, Star01, TrendUp01 } from "@untitledui/icons";
