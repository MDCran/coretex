...
import { Trash02, Plus } from "@untitledui/icons";
...
export function SplitModal({
    ...
    const splitsMutation = useLifeOSMutation(client, "financial:setTransactionSplits");
    const pending = splitsMutation.pending;
    ...
    async function save() {
        ...
        try {
            await splitsMutation.mutate({ id: transactionId, splits: clean });
    ...
    async function clearSplit() {
        try {
            await splitsMutation.mutate({ id: transactionId, splits: [] });
