...
import { ArrowUpRight, ArrowDownRight, Camera01, Plus, UploadCloud02, Receipt, CreditCard02 } from "@untitledui/icons";
                    ...
                    <tbody>
                        ...
                        {data.recent.map((t) => (
                            <tr key={t.id} className="border-b border-secondary last:border-0">
                                ...
                                <td className="px-5 py-3">{t.category ? <CategoryBadge name={t.category} color={t.categoryColor} /> : <CategoryBadge name="Uncategorized" />}</td>
