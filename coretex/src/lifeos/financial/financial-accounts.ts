...
import { bool, num, parseOptionalDateOnly, parseOptionalDateTime, str } from "./financial-shared.js";
...
/** Derive a last-4 from a full account number (for masked display & statement naming). */
